...
import { generateWorkout, WARMUP_COUNT, COOLDOWN_COUNT, WORKOUT_TARGET_MINUTES } from '@/lib/workout-engine';
    ...
    <main>
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', justifyContent: 'center', textAlign: 'center' }}>
        <div style={{ marginBottom: '2rem' }}>
          ...
          <p>Your personal ~{WORKOUT_TARGET_MINUTES + (WARMUP_COUNT * 0.5) + (COOLDOWN_COUNT * 0.5)} minute trainer.</p>
        </div>
        ...
        <div style={{ display: 'grid', gap: '1rem', textAlign: 'left', background: 'var(--card-bg)', padding: '1.5rem', borderRadius: '20px', marginBottom: '2rem', border: '1px solid var(--card-bg)' }}>
          <div style={{ display: 'flex', gap: '1rem' }}>
            ...
            <div>
              <p style={{ fontWeight: '700', color: 'var(--foreground)' }}>{WARMUP_COUNT} Warm-up Stretches</p>
          ...
          <div style={{ display: 'flex', gap: '1rem' }}>
            ...
            <div>
              <p style={{ fontWeight: '700', color: 'var(--foreground)' }}>{COOLDOWN_COUNT} Cool-down Stretches</p>
